  ...
  return (
    <div>
      ...
      <div className="bg-card border border-border rounded-xl p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-1">Student ID: STU-{String(student.id).padStart(4, "0")}</p>
            <div className="flex flex-wrap gap-2 mt-3">
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-primary/15 text-primary">{student.grade}</span>
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-success/15 text-success">{student.status}</span>
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-info/15 text-info">{student.gender}</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          ...
          <div className="space-y-3">
            {[
              ...
              { label: "Student ID", value: `STU-${String(student.id).padStart(4, "0")}`, editable: false },
              { label: "Date of Birth", value: student.dob, editable: false },
              ...
              { label: "Enrolled Since", value: student.enrollDate, editable: false },
            ].map((item) => (
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          <h3 className="font-semibold text-foreground mb-4">Father / Guardian Information</h3>
          <div className="space-y-3">
            {[
