...
const TeacherAssignments = ({ teacher }: Props) => {
        ...
        a.id === selectedAssignment.id
          ? {
              ...
              submissions: a.submissions.map((s) =>
                s.studentId === gradingStudent
                  ? { ...s, marks, feedback: gradingFeedback }
                  : s
              ),
            }
          : a
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewAssignment({ ...newAssignment, classGrade: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewAssignment({ ...newAssignment, chapterName: e.target.value })
                }
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              onChange={(e) =>
                setNewAssignment({ ...newAssignment, question: e.target.value })
              }
              rows={3}
  ...
  if (view === "detail" && selectedAssignment) {
    ...
    const graded = selectedAssignment.submissions.filter(
      (s) => s.marks !== undefined
    );
      ...
      <div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {selectedAssignment.subject} · Class {selectedAssignment.classGrade}
          </p>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {sub.marks !== undefined ? (
                    ...
                    <button
                      onClick={() => {
                        setGradingStudent(sub.studentId);
                        setGradingMarks(
                          sub.marks !== undefined ? String(sub.marks) : ""
                        );
